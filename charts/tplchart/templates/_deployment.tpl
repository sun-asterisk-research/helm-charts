...
spec:
  ...
  selector:
    matchLabels:
      {{- include "tplchart.matchLabels" (dict "customLabels" (list $Args.podLabels $Values.podLabels .context.Values.commonLabels) "component" $Args.component "context" .context) | nindent 6 -}}
